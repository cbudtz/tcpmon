...
class AdminPane extends JPanel {
  ...
  public AdminPane(JTabbedPane notebook, String name) {
    ...
    mainPane.add(new JLabel(TCPMon.getMessage("newTCP00", "Create a new TCPMon...") + " "), c);
    ...
    c.anchor = GridBagConstraints.WEST;
    c.gridwidth = 1;
    tmpPanel.add(new JLabel(TCPMon.getMessage("listenPort00", "Listen Port #") + " "), c);
    c.anchor = GridBagConstraints.WEST;
    c.gridwidth = GridBagConstraints.REMAINDER;
    ...
    mainPane.add(hostLabel = new JLabel(TCPMon.getMessage("targetHostname00", "Target Hostname") + " "), c);
    c.anchor = GridBagConstraints.WEST;
    c.gridwidth = GridBagConstraints.REMAINDER;
    ...
    c.gridwidth = 1;
    mainPane.add(Box.createRigidArea(new Dimension(25, 0)));
    mainPane.add(tportLabel = new JLabel(TCPMon.getMessage("targetPort00", "Target Port #") + " "), c);
    c.anchor = GridBagConstraints.WEST;
    c.gridwidth = GridBagConstraints.REMAINDER;
    ...
    c.anchor = GridBagConstraints.WEST;
    c.gridwidth = 1;
    opts.add(HTTPProxyHostLabel = new JLabel(TCPMon.getMessage("hostname00", "Hostname") + " "), c);
    ...
    c.anchor = GridBagConstraints.WEST;
    c.gridwidth = 1;
    opts.add(HTTPProxyPortLabel = new JLabel(TCPMon.getMessage("port00", "Port #") + " "), c);
    ...
    c.anchor = GridBagConstraints.WEST;
    c.gridwidth = 1;
    delayBytesLabel = new JLabel(TCPMon.getMessage("delay01", "Bytes per Pause"));
    ...
    c.anchor = GridBagConstraints.WEST;
    c.gridwidth = 1;
    delayTimeLabel = new JLabel(TCPMon.getMessage("delay02", "Delay in Milliseconds"));
    ...
    addButton.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent event) {
        if (add.equals(event.getActionCommand())) {
          ...
          final int proxyPort = HTTPProxyPort.getValue(-1);
          if (proxyPort != -1) {
    ...
    c.anchor = GridBagConstraints.WEST;
    c.gridwidth = GridBagConstraints.REMAINDER;
    final String load = TCPMon.getMessage("load00", "Load");
    mainPane.add(loadButton = new JButton(load), c);
    loadButton.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        ListenerData[] ldata = null;
        try {
          ldata = mapper.readValue(new File("customPorts.json"), ListenerData[].class);
        } catch (final IOException e1) {
          // TODO fix chbu 8. sep. 2016: Implement exception handling
          e1.printStackTrace();
        }
        for (final ListenerData listenerData : ldata) {
          new Listener(noteb, listenerData.getName(), listenerData.getListenPort(), listenerData.getTargetHost(),
              listenerData.getTargetPort(), false, null);
